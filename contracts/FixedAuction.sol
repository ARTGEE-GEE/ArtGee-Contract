...
contract FixedAuction is Operator{
    ...
    event Auction(uint256 indexed _auctionId, address _token, 
                    ...
                    uint256 _openingBid, uint256 _fixedPrice,uint256 startTime);
    ...
    event Fixed(uint256 indexed _auctionId, address _bidder, uint256 _openingBid);
    ...
    function auction(address _token, uint256 _tokenId, 
        ...
        emit Auction(auctionId,_token, _tokenId, msg.sender, _openingBid,_fixedPrice, t);
    }
    ...
    function reAuction(uint256 _auctionId, uint256 _openingBid, 
        ...
        emit ReAuction(_auctionId, bidInfo.token, bidInfo.tokenId, msg.sender, _openingBid, _fixedPrice, t);
    }
    ...
    function fixedWithdraw(uint256 _auctionId) payable public{
        ...
        require(bidInfo.fixedPrice == msg.value,"Not fiexed price");
        ...
        // to seller
        transferMain(bidInfo.seller, amount.sub(_fee).sub(_artistFee));
        emit Fixed(_auctionId,bidInfo.bidder,amount.sub(_fee).sub(_artistFee));
    }
